...
import { Target, CheckCircle, TrendingUp, DollarSign } from 'lucide-react';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Link } from 'react-router-dom';

const ModerateGrowthPortfolio = () => {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
            <div className="text-center">
              ...
              <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-3xl mx-auto">
                A balanced approach combining growth potential with risk management, perfect for investors seeking moderate returns with diversified exposure.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link to="/wealth/portfolio-analysis">
                  <Button variant="outline" className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-700 transition-colors text-lg">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">6-8% annually</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Balanced growth and income</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Schedule a consultation to learn more about our Moderate Growth Portfolio.
            </p>
            <Link to="/contact-us">
...
export default ModerateGrowthPortfolio;
