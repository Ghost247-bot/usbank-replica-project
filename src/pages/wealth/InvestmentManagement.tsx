...
const InvestmentManagement = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Expert guidance on investment strategies and market trends"
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "Personal investment advisors committed to your success"
    }
  ];
        ...
        <section className="bg-gradient-to-r from-green-700 to-green-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-5xl font-bold mb-6">Investment Management</h1>
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Professional portfolio management to help you achieve your financial goals
              </p>
