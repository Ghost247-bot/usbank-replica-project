...
import { Globe, CreditCard, TrendingUp, Shield } from 'lucide-react';
...
const InternationalBanking = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Currency hedging and risk mitigation"
    }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="bg-gradient-to-r from-green-700 to-green-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-5xl font-bold mb-6">International Banking</h1>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12">Global Services</h2>
