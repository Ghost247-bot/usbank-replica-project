...
const AccountOverview = () => {
  ...
  const accountData = [
    ...
    },
    {
      ...
      amount: balancesByType.checking || 0,
    ...
    },
    {
      ...
      amount: balancesByType.savings || 0,
      description: "4.25% APY earning",
      route: "/accounts/savings",
      icon: "🏦"
    },
    {
      title: "Investment Account",
      amount: balancesByType.investment || 0,
    ...
    },
    {
      ...
      amount: balancesByType.escrow || 0,
    ...
    {
      title: "Credit Card",
      amount: Math.abs(balancesByType.credit_card || 0),
