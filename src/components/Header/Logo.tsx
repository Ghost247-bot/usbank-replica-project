    ...
    <div className="flex-shrink-0">
      <div className="flex items-center transform transition-all duration-300 hover:scale-110 cursor-pointer">
        ...
        <div className="ml-2 lg:ml-3 min-w-0">
          <span className="hidden sm:inline text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 whitespace-nowrap">Moonstone Holdings</span>
          <span className="sm:hidden text-base font-bold text-gray-800">MH</span>
        </div>
      </div>
    </div>
  );
