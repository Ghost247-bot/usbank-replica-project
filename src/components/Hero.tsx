      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="animate-fade-in">
            ...
            <p className="text-lg mb-6 text-green-100 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="hidden lg:block animate-fade-in" style={{ animationDelay: '0.9s' }}>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 text-center transform transition-all duration-300 hover:scale-105 hover:bg-white/20">
                <Shield className="h-10 w-10 mx-auto mb-3 text-green-200 animate-pulse" />
                <h3 className="text-base font-semibold mb-2">Secure Banking</h3>
                <p className="text-green-100 text-sm">Advanced security measures to protect your assets</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 text-center mt-6 transform transition-all duration-300 hover:scale-105 hover:bg-white/20">
                <CreditCard className="h-10 w-10 mx-auto mb-3 text-green-200 animate-pulse" style={{ animationDelay: '0.5s' }} />
                <h3 className="text-base font-semibold mb-2">Easy Payments</h3>
                <p className="text-green-100 text-sm">Convenient payment solutions for everyday needs</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 text-center -mt-6 transform transition-all duration-300 hover:scale-105 hover:bg-white/20">
                <TrendingUp className="h-10 w-10 mx-auto mb-3 text-green-200 animate-pulse" style={{ animationDelay: '1s' }} />
                <h3 className="text-base font-semibold mb-2">Smart Investing</h3>
                <p className="text-green-100 text-sm">Grow your wealth with expert investment guidance</p>
              </div>
            </div>
          </div>
        </div>
